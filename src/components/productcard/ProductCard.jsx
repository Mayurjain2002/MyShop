...
function ProductCard() {
    ...
    return (
        <section className="text-gray-600 body-font">
            <div className="container px-10 py-10 md:py-16 mx-auto">
                <div class="lg:w-1/2 w-80 mb-6 lg:mb-10">
                ...
                <div className="flex flex-wrap m-10">
                    ...
                    .filter((obj) => obj.price.includes(filterPrice)).slice(0,4)
                    .map((item,index) =>{
                        ...
                        <div className="h-full border-2 hover:shadow-gray-100 hover:shadow-2xl transition-shadow duration-300 ease-in-out    border-gray-200 border-opacity-60 rounded-2xl overflow-hidden" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                            <div className="flex justify-center cursor-pointer" >
                                <img className=" rounded-2xl w-55 h-55 p-2 hover:scale-110 transition-scale-110  duration-300 ease-in-out" src={imageURL} alt="blog" />
                            </div>
                            <div className="p-3 border-t-2">
                                <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1" style={{ color: mode === 'dark' ? 'white' : '', }}>MyShop</h2>
